...
(module+ test
  ...
  (check-equal? (merge-k-lists (map list->linked-list '((1 4 5) (1 3 4) (2 6))))
                (list->linked-list '(1 1 2 3 4 4 5 6)))
  (check-equal? (merge-k-lists '()) (list->linked-list '()))
  (check-equal? (merge-k-lists (list (list->linked-list '()))) (list->linked-list '())))
